Monologue.config do |config|
  config.site_name = "Niche-ie Blog"
  # config.site_subtitle = "Brooklyn Niche Blog"
  config.site_url = "http://www.niche-ie.com"

  config.meta_description = "interior design and decoration"
  config.meta_keyword = "design, clean"
  ...
  config.sidebar = ["latest_posts", "tag_cloud"]
